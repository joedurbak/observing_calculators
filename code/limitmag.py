...
if __name__ == '__main__':
    result, eta = exptimecalc('h2rg', 'J', 0, 21.0, 5.0)  # detector, band, resolvingPower (0, 30 ,4000), magAB, sigma
    print(result, eta)
    result, eta = limit('h2rg', 'Y', 4000, 600.0,5.0)  # detector, band, resolvingPower (0, 30 ,4000), exposure_time, sigma
    print(result, eta)
